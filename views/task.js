function addTask() {
  ...
  task_div.innerHTML = `<img src="MainLogo.jpg" class="image"> Task-${table.rows.length + 1}`;
  ...
  editLink.addEventListener('click', function() {
    ...
    window.location.href = `/task_des?taskdate=${encodeURIComponent(taskdate)}`;
  });
...
function addSubtask(event) {
  ...
  const editLink = document.createElement("a");
  editLink.href = "task_des"; // Add your href value here
  editLink.innerHTML = '<img src="edit_pic.svg" alt="Clickable Image">';
  editLink.classList.add("editLink");
